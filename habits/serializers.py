...
from habits.validators import validate_mutual_exclusion, validate_periodicity, validate_duration, \
    validate_related_habit, validate_pleasant_habit
...
class HabitSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Habit
        fields = [
            'id', 'owner', 'place', 'time', 'action',
            'is_pleasant', 'related_habit', 'period_days',
            'reward_text', 'duration_seconds', 'is_public',
        ]
